        ...
        <div className="max-w-6xl mx-auto px-6 w-full">
          ...
          >
            <motion.p
              ...
              className="text-emerald-800 font-extrabold text-lg uppercase tracking-widest mb-4"
            >
              Our Legacy
            </motion.p>
            ...
            <motion.h1
              variants={itemVariants}
              className="text-5xl md:text-7xl lg:text-8xl font-black text-stone-900 tracking-tight leading-[1.05] mb-8 drop-shadow-sm"
            >
              <span className="text-emerald-800">Tuyom's</span> <br />
              <span className="text-[#E17100]">Heritage</span>
            </motion.h1>

            <motion.p
              variants={itemVariants}
              className="text-lg md:text-xl text-emerald-900 max-w-2xl leading-relaxed font-medium"
            >
              Discover the rich history, vibrant culture, and timeless
              traditions that shape the soul of our coastal community.
            </motion.p>
          </motion.div>
        </div>
      </section>
