              ...
              <table className="w-full text-left border-collapse min-w-[700px]">
                <thead>
                  <tr className="border-b-2 border-stone-100">
                    <th className="p-5 text-xs font-black text-stone-400 uppercase tracking-widest">
                      Cardano Tx Hash
                    </th>
                    <th className="p-5 text-xs font-black text-stone-400 uppercase tracking-widest">
                      Date
                    ...
                    <th className="p-5 text-xs font-black text-stone-400 uppercase tracking-widest text-right">
                      Status
                    </th>
                  </tr>
                </thead>
                <tbody className="text-sm font-semibold text-stone-600">
                  {requests.map((req, index) => (
                    ...
                    >
                      ...
                      <td className="p-5 text-right">
                        <span
                          className={`inline-flex items-center justify-center px-4 py-1.5 rounded-full text-[10px] font-black uppercase tracking-widest shadow-sm transition-all ${
                            req.status === "On-Chain"
                  ...
                  {requests.length === 0 && (
                    <tr>
                      <td
                        colSpan="4"
                        className="p-16 text-center text-stone-400 font-medium"
                      >
